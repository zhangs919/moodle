 ...
 */
function theme_andy_process_css($css, $theme) {
    ...
    $css = theme_andy_set_customcss($css, $customcss);
 ...
 */
function theme_andy_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 */
function theme_andy_set_customcss($css, $customcss) {
 ...
 */
function theme_andy_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
...
/**
 * All theme functions should start with theme_andy_
 * @deprecated since 2.5.1
 */
function andy_process_css() {
